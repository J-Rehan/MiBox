						...
						<tr>
							<td style="background-color:#fff;padding: 37px 30px 0; text-align: left;"  class="mobile-section">
								<table class="content-box inner-container" style="width: 100%">
                                    <tr>
                                        <td style="padding-bottom:30px;"> Hello, <?php echo e($customer->first_name); ?> <?php echo e($customer->last_name); ?></td>
                                    </tr>
									<tr>
										<td style="text-align: center">
                                            <figure class="thankyou-img">
                                                <img src="<?php echo e(asset('images/thankyou.png')); ?>" alt="thankyou" class="img-fluid">
...
</html><?php /**PATH /var/www/html/mibox/resources/views/emails/customer_email.blade.php ENDPATH**/ ?>