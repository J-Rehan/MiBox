      ...
      <div class="col-md-7 m-auto text-center">
        <div class="thankyou-box">
          <figure class="thankyou-img">
            <img src="<?php echo e(asset('images/thankyou.svg')); ?>" alt="" class="img-fluid">
          </figure>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/mibox/resources/views/pages/page_7.blade.php ENDPATH**/ ?>